...
namespace ChefDheeraj
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IRepository<Receipe>, ChefRepository<Receipe>>();
            var connectionString = Configuration.GetConnectionString("ChefDheerajDB");
